...
namespace EvaluationStrategy {
  ...
  enum Strategy {
    TEMPORARY_VECTOR, PERSISTENT_VECTOR, PERSISTENT_VECTOR_OFFSET, TEMPORARY_MAP, TEMPORARY_UNORDERED_MAP,
    TEMPORARY_MAP_EDITING, TEMPORARY_UNORDERED_MAP_EDITING
  };
